                                    ...
                                    <div class="okay_list_row">
                                        ...
                                        <div class=" okay_list_setting okay_list_products_setting">
                                            ...
                                            <div class="">
                                                ...
                                                {*open*}
                                                <a href="../{url_generator route="product" url=$product->url}" target="_blank" data-hint="{$btr->general_view|escape}" class="setting_icon setting_icon_open hint-bottom-middle-t-info-s-small-mobile  hint-anim">
