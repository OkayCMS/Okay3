{$meta_title = $btr->okaycms__yandex_xml__title|escape scope=global}
    ...
    <div class="col-lg-12 col-md-12">
        <div class="wrap_heading">
            <div class="box_heading heading_page">
                {$btr->okaycms__yandex_xml__title|escape}
            </div>
        </div>
    </div>
</div>
...
<form method="post" enctype="multipart/form-data" class="fn_fast_button fn_is_translit_alpha">
        ...
        <div class="col-lg-12 col-md-12">
            <div class="boxed fn_toggle_wrap">
                <div class="heading_box">
                    {$btr->okaycms__yandex_xml__params|escape}
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-1">
                            <div class="heading_label">
                                <strong>{$btr->okaycms__yandex_xml__company}</strong>
                            </div>
                            <div class="mb-1">
                        ...
                        <div class="col-md-6 mb-1">
                            <div class="heading_label">
                                <strong>sales notes</strong> * <span class="text_warning">{$btr->okaycms__yandex_xml__sales_max_length|escape}</span>
                            </div>
                            <div class="mb-1">
                                <input id="okaycms__yandex_xml_sales_notes" name="okaycms__yandex_xml__sales_notes" class="form-control" type="text" value="{$settings->okaycms__yandex_xml__sales_notes}" />
                            </div>
                        </div>
                        <div class="col-md-6 mb-1">
                            <div class="heading_label">
                                <strong>{$btr->okaycms__yandex_xml__country_of_origin}</strong>
                            </div>
                            <div class="mb-1">
                                <select name="okaycms__yandex_xml__country_of_origin" class="selectpicker">
                                    <option {if $settings->okaycms__yandex_xml__country_of_origin == 0}selected=""{/if} value=""></option>
                                    {foreach $features as $feature}
                                        <option {if $settings->okaycms__yandex_xml__country_of_origin == $feature->id}selected=""{/if} value="{$feature->id}">{$feature->name}</option>
                                    {/foreach}
                                </select>
                            </div>
                        </div>
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="boxed fn_toggle_wrap">
                <div class="heading_box">
                    {$btr->okaycms__yandex_xml__edit_and_add_feeds|escape}
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <button class="btn btn-info btn_big mb-1 fn_add_feed" type="submit" name="add_feed" value="1">
                            <span>{$btr->okaycms__yandex_xml__add_feed}</span>
                        </button>
                    </div>
                    <div class="col-md-12">
                        <div class="tabs">
                                                                ...
                                                                <div class="alert__content">
                                                                    <div class="alert__title">
                                                                        {if isset($errors['feeds'][$feed->id]['url'])}
                                                                            {$btr->okaycms__yandex_xml__error_url_exist|escape}
                                                                        {elseif isset($errors['feeds'][$feed->id]['url_cyrillic'])}
                                                                            {$btr->okaycms__yandex_xml__error_url_cyrillic|escape}
                                                                        {/if}
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <button class="btn btn-outline-danger btn_big float-md-right" name="remove_feed" value="{$feed->id}">
                                                                <span>{$btr->okaycms__yandex_xml__remove_feed}</span>
                                                            </button>
                                                        </div>
                                                    </div>
                                                {/if}
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <div class="heading_label">
                                                                <span>URL</span>
                                                                <i class="fn_tooltips" title="{$btr->okaycms__yandex_xml__error_url_cyrillic|escape}">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="alert alert--icon alert--info">
                                                            <div class="alert__content">
                                                                ...
                                                                <p>{$btr->okaycms__yandex_xml__generation_url|escape} <a href="{url_generator route='OkayCMS_YandexXML_feed' url=$feed->url absolute=1}" target="_blank">{url_generator route='OkayCMS_YandexXML_feed' url=$feed->url absolute=1}</a></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="heading_box">
                                                    {$btr->okaycms__yandex_xml__upload_products|escape}
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-md-6">
                                                        <div class="boxed match fn_toggle_wrap">
                                                            <div class="heading_box">
                                                                {$btr->okaycms__yandex_xml__categories}
                                                                <button class="btn btn_small btn-info" name="add_all_categories" value="{$feed->id}">{$btr->okaycms__yandex_xml__select_all}</button>
                                                                <button class="btn btn_small" name="remove_all_categories" value="{$feed->id}">{$btr->okaycms__yandex_xml__select_none}</button>
                                                            </div>
                                                            <div class="toggle_body_wrap on fn_card">
                                                    ...
                                                    <div class="col-lg-6 col-md-6">
                                                        <div class="boxed match fn_toggle_wrap">
                                                            <div class="heading_box">
                                                                {$btr->okaycms__yandex_xml__brands}
                                                                <button class="btn btn_small btn-info" name="add_all_brands" value="{$feed->id}">{$btr->okaycms__yandex_xml__select_all}</button>
                                                                <button class="btn btn_small" name="remove_all_brands" value="{$feed->id}">{$btr->okaycms__yandex_xml__select_none}</button>
                                                            </div>
                                                            <div class="toggle_body_wrap on fn_card">
