...
class Init extends AbstractInit
{
    public function install()
    {
        ...
        $this->migrateEntityTable(FAQEntity::class, [
            (new EntityField('id'))->setPrimaryKey()->setTypeInt(11, false)->setAutoIncrement(),
    ...
    public function init() {
        ...
        $this->registerUpdateObject('OkayCMS.FAQ.FAQEntity', 'okaycms__faq__faq', FAQEntity::class);
    }
}