    ...
    <div class="col-lg-12 col-md-12">
        <div class="alert alert--icon alert--info">
            <div class="alert__content">
                ...
                <p>{$btr->okaycms__yandex_xml_vendor_model__generation_url|escape} <a href="{url_generator route='OkayCMS_YandexXMLVendorModel_feed' absolute=1}" target="_blank">{url_generator route='OkayCMS_YandexXMLVendorModel_feed' absolute=1}</a></p>
            </div>
        </div>
    </div>
</div>
