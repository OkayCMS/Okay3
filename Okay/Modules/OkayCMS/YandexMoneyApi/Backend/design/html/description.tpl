    ...
    <div class="col-lg-12 col-md-12">
        <div class="alert alert--icon alert--info">
            <div class="alert__content">
                ...
                <p>{$btr->okaycms__yandex_money_api__description_part_1}: <b>{url_generator route='OkayCMS.YandexMoneyApi.Callback' absolute=1}?action=notify</b> {$btr->okaycms__yandex_money_api__description_part_2}
                    <br><br>
