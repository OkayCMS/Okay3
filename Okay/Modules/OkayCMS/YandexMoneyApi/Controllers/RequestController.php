...
class RequestController extends AbstractController
{
    ...
    const YAMONEY_MODULE_VERSION = '1.5.2';
    ...
    public function sendPaymentRequest(Settings $settings, EntityFactory $entityFactory, Config $config)
    {
        ...
        $builder->setConfirmation([
                ...
                'return_url' => Router::generateUrl('OkayCMS.YandexMoneyApi.Callback', [], true)."/?action=return&order_id={$orderId}",
            ]);
        $builder->setMetadata([
        ...
        if ($paymentSettings->ya_kassa_api_send_check && $paymentSettings->ya_kassa_api_send_check) {
