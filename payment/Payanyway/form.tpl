<form action="{$url}" method="post">
    ...
    {if $payment_system[0] == "post"}
        <div class="form__group">
            ...
            <input class="form__input" type=text name="additionalParameters.mailofrussiaSenderIndex" value="">
        </div>
        <div class="form__group">
            <label class="label_block">Регион (или город федерального значения) отправителя</label>
            <input class="form__input" type=text name="additionalParameters.mailofrussiaSenderRegion" value="">
        </div>
        <div class="form__group">
            <label class="label_block">Адрес отправителя</label>
            <input class="form__input" type=text name="additionalParameters.mailofrussiaSenderAddress" value="">
        </div>
        <div class="form__group">
            <label class="label_block">Имя отправителя</label>
            <input class="form__input" type=text name="additionalParameters.mailofrussiaSenderName" value="">
        </div>
    ...
    {elseif $payment_system[0] == "moneymail"}
        <div class="form__group">
            ...
            <input class="form__input" type="text" name="additionalParameters.buyerEmail" data-format="email" data-notice="Введите email" value="">
        </div>
    {elseif $payment_system[0] == "euroset"}
        <div class="form__group">
            <label class="label_block">Номер телефона</label>
            <input class="form__input" type="text" name="additionalParameters.rapidaPhone" data-format="{literal}(\+)(7)(\d){10,20}{/literal}" data-notice="Введите номер телефона в формате +71234567890" value="">
        </div>
    {elseif $payment_system[0] == "dengimail"}
        <div class="form__group">
            <label class="label_block">E-mail в системе Деньги@Mail.Ru</label>
            <input class="form__input" type="text" name="additionalParameters.dmrBuyerEmail" data-format="email" data-notice="Введите email" value="">
        </div>
    {elseif $payment_system[0] == "alfaclick"}
        <div class="form__group">
            <label class="label_block">Логин в интернет-банке</label>
            <input class="form__input" type="text" name="additionalParameters.alfaIdClient" value="">
        </div>
        <div class="form__group">
            <label class="label_block">Назначение платежа</label>
            <input class="form__input" type="text" name="additionalParameters.alfaPaymentPurpose" value="PayAnyWay invoice">
        </div>
    {elseif $payment_system[0] == "mts"}
        <div class="form__group">
            <label class="label_block">Номер телефона</label>
            <input class="form__input" type="text" name="additionalParameters.smsmsPhone" data-format="{literal}(7)(\d){10}{/literal}" data-notice="Введите номер телефона в формате: 71234567890" value="">
        </div>
    {elseif $payment_system[0] == "qiwi"}
        <div class="form__group">
            <label class="label_block">Номер телефона</label>
            <input class="form__input" type="text" name="additionalParameters.qiwiUser" value="" data-format="{literal}(\d){10}{/literal}" data-notice="Номер телефона вводится без \"8\"">
        </div>
        <div class="form__group">
            <label class="label_block">Комментарий</label>
            <input class="form__input" type="text" name="additionalParameters.qiwiComment" value="">
        </div>
    {/if}
