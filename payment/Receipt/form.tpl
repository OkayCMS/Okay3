<form action="payment/Receipt/callback.php" method="post">
    ...
    <div class="form__group">
        <input class="form__input" type="text" name="name" value="" placeholder="{$lang->receipt_name}*" required="">
    </div>
    <div class="form__group">
        <input class="form__input" type="text" name="address" value="" placeholder="{$lang->receipt_address}*" required="">
    </div>
