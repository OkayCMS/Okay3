...
полю, если не задана пользовательская сортировка с таким именем. Так же можно передавать название сортировки и 
...
Чтобы её описать, нужно в классе вашег Entity перегрузить метод customOrder().
...
Для этого нужно вызвать метод cols(), который принимает массив колонок, которые нужно достать.
